...
const Schedule: React.FC = () => {
  return (
    <Box p={{ base: 4, md: 6, lg: 8 }} maxW="1600px" mx="auto" minH="80vh" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
      <Flex direction="column" align="center" textAlign="center" gap={6}>
        ...
        <Box>
          <Heading size="2xl" mb={4} color="gray.800">Coming Soon</Heading>
          <Text fontSize="lg" color="gray.500" maxW="md">
            We are working hard to bring you the new Class Schedule feature. Stay tuned for updates!
          </Text>
        </Box>
      </Flex>
    </Box>
